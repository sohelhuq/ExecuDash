...
export const businessUnits: BusinessUnit[] = [
  {
    ...
    kpis: [
      { title: 'Total Revenue', value: '৳1,250,000', change: '+15.2%', icon: DollarSign },
  ...
  },
  {
    ...
    kpis: [
        { title: 'Monthly Recurring Revenue', value: '৳500,000', change: '+2.5%', icon: DollarSign },
  ...
  // Add other business units here...
  {
    ...
    kpis: [
        { title: 'Total Revenue', value: '৳2,500,000', change: '+25.0%', icon: DollarSign },
